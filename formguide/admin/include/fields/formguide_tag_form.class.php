...
class member_tag_form
{
    ...
    function __construct($modelid)
    {
		...
		$this->fields = $this->modelid ? cache_read($this->modelid.'_fields.inc.php', CACHE_MODEL_PATH) : cache_read('common_fields.inc.php', WSLM_ROOT.'member/admin/include/fields/');
