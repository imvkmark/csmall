...
?>
    ...
    <tr> 
      ...
      <td><?=form::select_template($mod, 'tag_config[template]', 'template', $template, '', 'tag_')?>&nbsp;<input type="button" value="修改选中模板" title="修改选中模板" onClick="$('#template_edit').show();$('#template_data').load('?mod=wslm&file=template&action=data_ajax&module=<?=$mod?>&template='+$('#template').val())"></td>
    </tr>
