...
{
	$.get("<?=WSLM_PATH?>load.php", { field: 'areaid', id: id },
		function(data){
...
<table cellpadding="0" cellspacing="1" class="table_form">
  ...
  <tr>
      ...
      <tr>
		...
		{
		?>
		<a href="javascript:confirmurl('?mod=wslm&file=admin&action=delete&userid=<?=$userid?>', '你确认撤销管理员“<?=$username?>”吗？');">撤销管理员</a>
		<?php
		}
		?>
		<?php
      ...
      <tr>
      	<th><strong>地区：</strong><br /><a href="?mod=wslm&file=area&action=add&forward=<?=urlencode(URL)?>">添加地区</a></th>
        <td>
        	<?php 
				if($areaid)
				{
