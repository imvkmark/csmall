<?php 
	...
	class member_model_field
	{
	    ...
	    function __construct($modelid)
	    {
			...
			$this->member_fields = cache_read('common_fields.inc.php', WSLM_ROOT.'member/admin/include/fields/');
	    }
	   ...
	   function listinfo($where = '', $order = '', $page = 1, $pagesize = 100)
	   {
		...
		function cache()
		{
			...
			$tablename = 'wslm_member_'.$MODEL[$this->modelid]['tablename'];
			...
			cache_write('wslm_'.$tablename.'.php', $datasource, WSLM_ROOT.'data/datasource/');
