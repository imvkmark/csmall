<?php
	...
	class member_model
	{
		...
		function add($model)
		{
			...
			$sql = file_get_contents(WSLM_ROOT.'member/admin/include/member_model.sql');
		...
		function cache()
		{
			...
			cache_common();
			$fields = array();
			$files = glob(WSLM_ROOT.'member/admin/include/fields/*');
		...
		{
			require_once WSLM_ROOT.'member/admin/include/model_member_field.class.php';
		...
		function cache_class($fields, $classname)
		{
			...
			{
				$r = @file_get_contents(WSLM_ROOT.'member/admin/include/fields/'.$field.'/'.$classname.'.inc.php');
				if($r) $data .= $r;
			}
			$classfile = 'member_'.$classname.'.class.php';
			$classcode = @file_get_contents(WSLM_ROOT.'member/admin/include/fields/'.$classfile);
