...
require_once WSLM_ROOT.'member/admin/include/model_member.class.php';
...
{
	require_once WSLM_ROOT.'formguide/admin/include/formguide_admin.class.php';
	require_once WSLM_ROOT.'formguide/admin/include/formguide_fields.class.php';
