...
switch($action)
{
    ...
    case 'tables':
	    ...
	    if($arrtables) echo form::select($arrtables, 'tablename', 'tablename', $tablename, 1, '', "onchange=\"$('#div_fields').load('?mod=wslm&file=datasource&action=fields&dbhost='+myform.dbhost.value+'&dbuser='+myform.dbuser.value+'&dbpw='+myform.dbpw.value+'&dbname='+myform.dbname.value+'&dbcharset='+myform.dbcharset.value+'&tablename='+myform.tablename.value)\"");
		break;
    case 'fields':
