...
<tr>
	...
	<td><a href='<?=$WSLM['siteurl']?>' style="color:red">网站首页</a></td>
	<td class='align_c'>首页</td>
	<td class='align_c'><a href='?mod=wslm&file=block&action=index'>首 页</a> | <font color='#cccccc'>内容页</font></td>
</tr>
<?=$categorys?>
</table>
<div class="button_box">
...
<table cellpadding="0" cellspacing="1" class="table_info">
  ...
  <tr>
	...
	您可以在模板中直接插入 <font color="red">{block('news', 1)}</font> 格式的碎片标签，然后进后台模板管理点击“<a href="?mod=wslm&file=template&action=tag&template=index&module=wslm&project=<?=TPL_NAME?>">可视化</a>”即可看到添加碎片的链接。<br />
	碎片参数说明：<br />
