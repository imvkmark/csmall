...
?>
<body>
<form action="?mod=wslm&file=urlrule&action=edit&urlruleid=<?=$urlruleid?>" method="post" name="myform">
<table cellpadding="2" cellspacing="1" class="table_form">
    ...
    <tr>
      <th></th>
      <td>
	  <input type="hidden" name="forward" value="?mod=wslm&file=urlrule&action=manage">
