...
<form action="?mod=<?=$mod?>&file=<?=$file?>&action=<?=$action?>&modelid=<?=$modelid?>" method="post" name="myform">
	...
	<tr> 
      ...
      <td><?=form::select_template('wslm', 'info[template_category]', 'template_category', $template_category, 'require="true" datatype="limit" msg="请选择栏目页模板"', 'category')?> <font color="red">*</font></td>
    </tr>
	<tr> 
      <th><strong>列表页模板</strong></th>
      <td><?=form::select_template('wslm', 'info[template_list]', 'template_list', $template_list,'require="true" datatype="limit" msg="请选择列表页模板"','list')?> <font color="red">*</font></td>
    </tr>
	<tr> 
      <th><strong>内容页模板</strong></th>
      <td><?=form::select_template('wslm', 'info[template_show]', 'template_show', $template_show,'require="true" datatype="limit" msg="请选择内容页模板"','show')?> <font color="red">*</font></td>
    </tr>
	<tr> 
      <th><strong>打印页模板</strong></th>
      <td><?=form::select_template('wslm', 'info[template_print]', 'template_print', $template_print,'','print')?> <font color="red">*</font></td>
    </tr>
	<tr>
