...
?>
<form action="?mod=wslm&file=safe&action=replace" method="POST">
...
<td style="text-align:center;"><a href="?mod=wslm&file=safe&action=see_code&files=<?=urlencode($key)?>">查看</a> | <a href="?mod=wslm&file=safe&action=del_file&files=<?=urlencode($key)?>" onclick="return confirm('您确定要删除<?=$key?>吗？\n删除后不可恢复哟！')">删除</a></td>
</tr>
<?php endforeach;?>
<tr>
