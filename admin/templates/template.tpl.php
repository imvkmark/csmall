...
<td class="align_c" width="40"><?php if($template['isdefault']){?><a href="?mod=wslm&file=template&action=add&module=<?=$module?>&project=<?=$project?>&templatename=<?=urlencode($template['name'])?>&templatetype=<?=$template['type']?>" title="新建<?=$template['name']?>类型模板(<?=$template['type']?>)" style="color:red">+</a><?php }?></td>
