...
?>
<form action="?mod=wslm&file=safe&action=edit_code" method="POST">
<table width="95%" cellpadding="0" class="table_form" cellspacing="1">
 ...
 <tr>
 <td></td>
 <td> <input type="button" onclick="location.href='?mod=wslm&file=safe&action=scan_table'" value="返回扫描列表"></td>
 </tr>
</table>
</form>
