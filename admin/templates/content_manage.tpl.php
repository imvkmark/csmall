...
<td class="align_c">
<?php 
if($model_field->exists('typeid')) echo form::select_type('wslm', 'typeid','typeid','类别', $typeid, '', $modelid);
?>
