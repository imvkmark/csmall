...
&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="编辑标签" onClick="javascript:window.location='?mod=wslm&file=tag&action=quickoperate&operate=edit&job=edittemplate&tagname=<?=urlencode($tagname)?>';">
