...
<form action="?mod=<?=$mod?>&file=<?=$file?>&action=<?=$action?>&modelid=<?=$modelid?>" method="post" name="myform" enctype="multipart/form-data">
  <caption>导入模型</caption>
	...
	<tr> 
      ...
      <td><?=form::select_template('wslm', 'info[template_category]', 'template_category','category','','category')?> <font color="red">*</font></td>
    </tr>
	<tr> 
      <th><strong>列表页模板</strong></th>
      <td><?=form::select_template('wslm', 'info[template_list]', 'template_list','list','','list')?> <font color="red">*</font></td>
    </tr>
	<tr> 
      <th><strong>内容页模板</strong></th>
      <td><?=form::select_template('wslm', 'info[template_show]', 'template_show','show','','show')?> <font color="red">*</font></td>
    </tr>
	<tr> 
