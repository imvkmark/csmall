...
?>
  <tr bgcolor="<?=$info['bgcolor']?>" >
    <td class="align_c"><input type="checkbox" name="filenames[]" value="<?=$info['filename']?>" id="sql_wslm" boxid="sql_wslm"></td>
...
<input name='wslm_all' title="全部" type='button' id='wslm_all' onclick="CheckedRev('sql_wslm','wslm_all')"  value="全选" />
&nbsp;&nbsp;
