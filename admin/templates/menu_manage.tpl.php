...
<div class="button_box">
	 ...
	 <input name="addmenu" type="button" value="添加菜单" onclick="redirect('?mod=wslm&file=menu&action=add&parentid=<?=$parentid?>&parentname=<?=urlencode($parentname)?>&forward=<?=urlencode(URL)?>')" />
</div>
<div id="pages">
	<?=$m->pages?>
</div>
