...
<a href="?mod=wslm&file=statistics&roles=<?php echo $val['roleid']?>"><?php echo $val['name']?></a>
<?php endforeach;?>
</td>
</tr>
</table>
...
foreach ($roles as $key=>$v)
{
	if($v)
	{
		echo "<a href='?mod=wslm&file=statistics&roles=".$val['roleids'][$key]."'>$v</a> ";
	}
}
?></td>
...
<td class="align_c"><a href="?mod=wslm&file=<?=$file?>&action=show_users&userid=<?=$val['userid']?>">统计报表</a></td>
</tr>
<?php endforeach;?>
</table>