...
&nbsp;&nbsp;<input type="button" name="edittpl" value="修改选择的模板" onClick="window.location='?mod=wslm&file=template&action=edit&template='+myform.template.value+'&module=guestbook&forward=<?=urlencode(URL)?>'"> 【注:只能修改非默认模板】
      </td>
    </tr>
	<tr>
