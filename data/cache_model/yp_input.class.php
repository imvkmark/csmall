...
class yp_input
{
	...
	{
		global $WSLM,$aids,$mod,$catid,$attachment,$contentid;
	...
	{
	    global $WSLM,$aids,$mod,$catid,$attachment,$contentid,$MODULE;
		$upload_maxsize = 1024*$this->fields[$field]['upload_maxsize'];
		...
		foreach($attachment->attachments[$field] as $aid=>$f)
		{
			...
			if($this->fields[$field]['iswatermark']) $image->watermark($img, '', $WSLM['watermark_pos'], $this->fields[$field]['watermark_img'], '', 5, '#ff0000', $WSLM['watermark_jpgquality']);
		}
	...
	function keyword($field, $value)
	{
		if(!$value)
		{
		    if(extension_loaded('scws'))
	        {
				...
				require_once WSLM_ROOT.'api/keyword.func.php';
