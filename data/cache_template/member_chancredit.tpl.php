...
<div id="right">
<p id="position"> <strong>当前位置：</strong><a href="<?php echo $M['url'];?>index.php">会员中心</a>积分兑换</p>
<form name="myform" method="post" action="<?php echo $M['url'];?>changecredit.php">
...
<caption>积分兑换</caption>
    ...
    <tr>
    	...
    	<td>
        	<input type="text" name="fromcredit" id="fromcredit" require="true" datatype="require|number|ajax" url="<?php echo $M['url'];?>changecredit.php?action=checkcredit" param="" msg="支出不能为空！|支出格式必须为整数|" msgid="err" /> 
