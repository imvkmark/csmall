...
<title>文件上传</title>
<base href="<?php echo $WSLM['siteurl'];?>" />
...
function doCheck() 
{
if(upload.<?php echo $uploadtext;?>.value == '') {
alert('请选择文件!');
return false;
}
return true;
...
<form name="upload" method="post" action="upload_field.php" enctype="multipart/form-data" onSubmit="return doCheck();">
