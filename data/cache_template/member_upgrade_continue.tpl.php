...
<div id="right">
  <p id="position"> <strong>当前位置：</strong><a href="">首页</a><a href="<?php echo $M['url'];?>index.php">会员中心</a><a href="<?php echo $M['url'];?>upgrade.php">会员升级</a>会员续费</p>
  <form action="<?php echo $M['url'];?>upgrade.php?action=continue&groupid=<?php echo $groupid;?>" method="post" name="myform" onsubmit="return checkform()">
    <input type="hidden" name="forward" value="<?php echo $forward;?>">
    <table cellpadding="0" cellspacing="1" class="table_info">
    <caption>会员续费</caption>
      <tr>
      ...
      <tr>
        <th><b>服务期限：</b></th>
        <td>从 <span style="color:red"><?php echo $startdate;?></span> 到 <span style="color:red"><?php echo $enddate;?></span></td>
      </tr>
      <tr>
        <th><b>会员资费：</b></th>
...
<?php if($price_d>0) { ?><input type="radio" name="unit" id="price_d" value="d" onclick="set_amount()"> 包日： <?php echo $price_d;?><?php echo $unitname;?>/天<br /><?php } ?>
     ...
     <tr>
        <th></th>
        <td><input type="submit" name="dosubmit" value="确定续费"></td>
      </tr>
    </table>
  </form>
</div>
