...
define('CACHE_IMPORT_PATH', WSLM_ROOT.'data/cache_import/');
require WSLM_ROOT.'include/admin/import_funcs.inc.php';
if(!class_exists('import'))
{
	require WSLM_ROOT.'include/admin/import.class.php';
}
$import = new import();
if(!class_exists('datasource'))
{
	require WSLM_ROOT.'include/admin/datasource.class.php';
}
$datasource = new datasource();
$mail_datadir = WSLM_ROOT.'data/mail/data/';
switch ($action)
{
    case 'import':
