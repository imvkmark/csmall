...
<table cellpadding="0" cellspacing="1" class="table_form">
	...
	<tr>
      ...
      <td><input type="text" name="info[filename]" id="filename" size="25" regexp="^[a-z0-9_]+$" require="true" datatype="limit|ajax" min="1" max="50" url="?mod=<?=$mod?>&file=<?=$file?>&action=checkname" msg="字符长度范围必须为1到50位|" msgid="msgid4"> <font color="#ff0000">.<?=$WSLM['fileext']?></font><span id="msgid4"></span></td>
    </tr>
	<tr>
