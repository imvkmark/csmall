...
<tbody id="urlrule_1" style="display:<?=$ishtml ? '' : 'none'?>">
	<tr>
	  ...
	  <a href="?mod=wslm&file=urlrule&action=add&module=special&filename=type&forward=<?=urlencode(URL)?>" style="color:red">点击新建URL规则</a></th>
	...
	<tr>
	  ...
	  <a href="?mod=wslm&file=urlrule&action=add&module=special&filename=show&forward=<?=urlencode(URL)?>" style="color:red">点击新建URL规则</a></th>
