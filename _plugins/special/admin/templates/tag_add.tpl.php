...
<table cellpadding="2" cellspacing="1" class="table_form">
    ...
    <tr> 
      ...
      <td><?=form::select_template($module, 'tag_config[template]', 'template', '', '', 'tag_special')?>&nbsp;<input type="button" value="修改选中模板" title="修改选中模板" onClick="location.href='?mod=wslm&file=template&action=edit&template='+ $('#template').val()+'&module=<?=$mod?>&forward=<?=urlencode(URL)?>'"></td>
    </tr>
    <tr> 
