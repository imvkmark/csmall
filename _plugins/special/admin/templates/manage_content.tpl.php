...
<td class="align_c">
<a href="?mod=wslm&file=content&action=view&catid=<?=$catid?>&contentid=<?=$info['contentid']?>">查看</a> |
<a href="?mod=wslm&file=content&action=edit&catid=<?=$catid?>&contentid=<?=$info['contentid']?>">修改</a> |
<a href="?mod=wslm&file=content&action=log_list&catid=<?=$catid?>&contentid=<?=$info['contentid']?>">日志</a>
