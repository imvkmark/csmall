...
DROP TABLE IF EXISTS `wslm_video`;
CREATE TABLE IF NOT EXISTS `wslm_video` (
...
--
-- 表的结构 `wslm_video_count`
--

DROP TABLE IF EXISTS `wslm_video_count`;
CREATE TABLE IF NOT EXISTS `wslm_video_count` (
...
--
-- 表的结构 `wslm_video_data`
--

DROP TABLE IF EXISTS `wslm_video_data`;
CREATE TABLE IF NOT EXISTS `wslm_video_data` (
...
--
-- 表的结构 `wslm_video_position`
--

DROP TABLE IF EXISTS `wslm_video_position`;
CREATE TABLE IF NOT EXISTS `wslm_video_position` (
...
--
-- 表的结构 `wslm_video_special`
--

DROP TABLE IF EXISTS `wslm_video_special`;
CREATE TABLE IF NOT EXISTS `wslm_video_special` (
...
--
-- 表的结构 `wslm_video_special_list`
--

DROP TABLE IF EXISTS `wslm_video_special_list`;
CREATE TABLE IF NOT EXISTS `wslm_video_special_list` (
...
DROP TABLE IF EXISTS `wslm_video_tag`;
CREATE TABLE IF NOT EXISTS `wslm_video_tag` (
