...
<table cellpadding="0" cellspacing="1" class="table_form">
   ...
   <tr>
      ...
      <td><input name='setting[skey]' type='text' id='skey' value='<?=$skey?>' size='32' maxlength='50'> <a href="http://www.ku6vms.com/register.php">必填项：请到 www.ku6vms.com 申请开通帐号</a> <a href="http://bbs.wslm.cn/thread-137916-1-1.html" target="_blank"><font color="red">使用帮助</font></a></td>
    </tr>
    <tr>
	...
	<tr>
	  ...
	  <a href="?mod=wslm&file=urlrule&action=add&module=video&filename=category&forward=<?=urlencode(URL)?>" style="color:red">点击新建URL规则</a></th>
      <td>
	...
	<tr>
	  ...
	  <a href="?mod=wslm&file=urlrule&action=add&module=video&filename=show&forward=<?=urlencode(URL)?>" style="color:red">点击新建URL规则</a></th>
      <td>
	...
	<tr>
	  ...
	  <a href="?mod=wslm&file=urlrule&action=add&module=video&filename=special&forward=<?=urlencode(URL)?>" style="color:red">点击新建URL规则</a></th>
      <td>
	...
	<tr>
	  ...
	  <a href="?mod=wslm&file=urlrule&action=add&module=video&filename=specialpage&forward=<?=urlencode(URL)?>" style="color:red">点击新建URL规则</a></th>
      <td>
