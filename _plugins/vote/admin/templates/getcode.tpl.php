...
<table cellpadding="2" cellspacing="1" border="0"  class="table_form">
  ...
  <tr align=center>
    <td>
<input name="tag" id="code3" type="text" size="100" value="{php include_once WSLM_ROOT.'/vote/include/common.inc.php' ; echo vote('<?=$templateid?>',<?=$voteid?>);}" onDblClick="clipboardData.setData('text',this.value); alert(this.value +'已复制到剪贴板');" >
...
$('#templateid3').change(function () {
  var tpl = $(this).val() ;
  tpl = "{php include_once WSLM_ROOT.'/vote/include/common.inc.php' ; echo vote('"+tpl+"',<?=$voteid?>);}" ;
  $('#code3').val(tpl);
});
