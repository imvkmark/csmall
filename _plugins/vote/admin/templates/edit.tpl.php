...
?>
     ...
     <tr>
		...
		&nbsp;<input type="button" value="修改选中模板" title="修改选中模板" onClick="location.href='?mod=wslm&file=template&action=edit&template='+ $('#template').val()+'&module=<?=$mod?>&forward=<?=urlencode(URL)?>'">
        </td>
     </tr>
   	<tr>
        <th><b>启用</b></th>
...
function uploadpic(obj){
	var id=$(obj).attr('sn');
	openwinx('?mod=wslm&file=upload&uploadtext=pic'+id,'upload','350','350');
}
