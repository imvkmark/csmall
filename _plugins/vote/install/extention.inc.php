...
$db->query("INSERT INTO ".DB_PRE."menu(parentid,name,image,url,description,target,style,js,groupids,roleids,isfolder,isopen,listorder,userid,keyid) VALUES (".$id.", '新建模板', '', '?mod=wslm&file=template&action=add&module=vote', '', 'right', '', '', '', '', 0, 0, 0, 0,'vote')");

$db->query("INSERT INTO ".DB_PRE."menu(parentid,name,image,url,description,target,style,js,groupids,roleids,isfolder,isopen,listorder,userid,keyid) VALUES (".$id.", '管理模板', '', '?mod=wslm&file=template&action=manage&module=vote', '', 'right', '', '', '', '', 0, 0, 0, 0,'vote')");
?>