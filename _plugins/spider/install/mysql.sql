INSERT INTO `wslm_module` VALUES ('spider', '采集管理', 'spider/', 'spider/', 0, '1.0.0.0', 'wslm', 'http://www.wslm.cn/', 'wslm@ku6.com', '', '', '', '', 'array (\n  ''Debug'' => ''0'',\n  ''CacheUrlTag'' => ''1'',\n  ''CacheTitleTag'' => ''1'',\n  ''keywordContentLenght'' => ''500'',\n ''titleLength'' => ''72'',\n  ''keywordNumber'' => ''4'',\n  ''keywordStrLength'' => ''4'',\n  ''keywordStrMaxLength'' => ''8'',\n  ''keywordFilter'' => '''',\n  ''descriptionLength'' => ''180'',\n)', 0, 0, '2009-05-20', '2009-05-20', '2009-05-20');

DROP TABLE IF EXISTS `wslm_spider_job`;
CREATE TABLE `wslm_spider_job` (
...
DROP TABLE IF EXISTS `wslm_spider_out`;
DROP TABLE IF EXISTS `wslm_spider_sites`;
CREATE TABLE `wslm_spider_sites` (
...
DROP TABLE IF EXISTS `wslm_spider_urls`;
CREATE TABLE `wslm_spider_urls` (
