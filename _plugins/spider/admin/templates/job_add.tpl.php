...
<caption>网址采集</caption>
	...
	<?=form::select_category('wslm', 0, 'parentid', 'parentid', '无（作为一级栏目）', $catid,$cat_js)?>&nbsp;<font color="Red">*</font></td>
	</tr>
	<tr>
...
function AddLabel(labelname,lnum)
{
	...
	document.all.userlabel.innerHTML+="<div id=\"fu"+labelnum+"\"  style=\"display:block\"><table width='100%' align='center'><tr ><td background='<?=WSLM_PATH?>/images/spacer.gif'></td></tr></table></div>";
	//自动载入发布字段模块
	setModelSelected();
