INSERT INTO `wslm_module` (`module`, `name`, `path`, `url`, `iscore`, `version`, `author`, `site`, `email`, `description`, `license`, `faq`, `tagtypes`, `setting`, `listorder`, `disabled`, `publishdate`, `installdate`, `updatedate`) VALUES ('mood', '心情指数', 'mood/', '', 0, '1.0.0.0', 'Wslm Team', 'http://www.wslm.cn/', 'wslm@163.com', '', '', '', '', '', 0, 0, '2008-10-28', '2008-10-28', '2008-10-28');

DROP TABLE IF EXISTS `wslm_mood`;
CREATE TABLE `wslm_mood` (
...
DROP TABLE IF EXISTS `wslm_mood_data`;
CREATE TABLE `wslm_mood_data` (
