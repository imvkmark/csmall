INSERT INTO `wslm_module` (`module`, `name`, `path`, `url`, `iscore`, `version`, `author`, `site`, `email`, `description`, `license`, `faq`, `tagtypes`, `setting`, `listorder`, `disabled`, `publishdate`, `installdate`, `updatedate`) VALUES ('pay', '支付', 'pay/', '', 0, '1.0.0.0', 'Wslm Team', 'http://www.wslm.cn/', 'wslm@163.com', '', '', '', '', 'array (\n  ''maxtopfailedtimes'' => ''0'',\n  ''maxiplockedtime'' => ''1'',\n  ''enabledkey'' => '','',\n)', 0, 0, '2008-10-28', '2008-10-28', '2008-10-28');

DROP TABLE IF EXISTS `wslm_pay_payment`;
CREATE TABLE `wslm_pay_payment` (
...
DROP TABLE IF EXISTS `wslm_pay_card`;
CREATE TABLE `wslm_pay_card` (
...
DROP TABLE IF EXISTS `wslm_pay_pointcard_type`;
CREATE TABLE `wslm_pay_pointcard_type` (
...
INSERT INTO `wslm_pay_pointcard_type` ( `name`, `point`, `amount`) VALUES ('金卡', 10, 100);
INSERT INTO `wslm_pay_pointcard_type` ( `name`, `point`, `amount`) VALUES ('银卡', 10, 80);

DROP TABLE IF EXISTS `wslm_pay_user_account`;
CREATE TABLE `wslm_pay_user_account` (
...
DROP TABLE IF EXISTS `wslm_pay_exchange`;
CREATE TABLE `wslm_pay_exchange` (
...
DROP TABLE IF EXISTS `wslm_pay_stat`;
CREATE TABLE `wslm_pay_stat` (
