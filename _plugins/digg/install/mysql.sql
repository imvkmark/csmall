INSERT INTO `wslm_module` (`module`, `name`, `path`, `url`, `iscore`, `version`, `author`, `site`, `email`, `description`, `license`, `faq`, `tagtypes`, `setting`, `listorder`, `disabled`, `publishdate`, `installdate`, `updatedate`) VALUES ('digg', '顶一下', 'digg/', '', 0, '1.0.0.0', 'Wslm Team', 'http://www.wslm.cn/', 'wslm@163.com', '顶一下', '', '', '', 'array (\n  ''mode'' => ''1'',\n)', 0, 0, '2008-10-28', '2008-10-28', '2008-10-28');

DROP TABLE IF EXISTS `wslm_digg`;
CREATE TABLE IF NOT EXISTS `wslm_digg` (
...
CREATE TABLE IF NOT EXISTS `wslm_digg_log` (
  `contentid` mediumint(8) unsigned NOT NULL default '0',
