...
('message', '短消息', 'message/', '', 0, '1.0.0.0', 'Wslm Team', 'http://www.wslm.cn/', 'wslm@163.com', '', '', '', '', '', 0, 0, '2008-10-28', '2008-10-28', '2008-10-28');

DROP TABLE IF EXISTS `wslm_message`;
CREATE TABLE IF NOT EXISTS `wslm_message` (
