 ...
 <font color="red">*</font>
	...
	<table cellpadding="0" cellspacing="0" id="table">
          ...
          <tbody id="flashid" style="display:none">
            <tr>
              <td> FLASH地址：&nbsp;<input type="text" name="ads[flashurl]" id="flashurl" value="" size="50" class="" /> <input type="button" name="ads[flashurl]_upimage" id="flashurl_upimage" value="上传FLASH" style="width:70px" onclick="javascript:openwinx('?mod=wslm&file=upload&uploadtext=flashurl','upload','380','350')"/><font color="red">*</font><br/>
                背景透明：
