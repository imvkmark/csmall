...
3、shtml调用消耗服务器资源少，访问速度快，支持Google等JS类代码广告，但是不能统计广告展示次数和自动判断广告有效期，需要服务器支持shtml，建议大型站点采用这种调用方式；如果您的站点网页后缀为.html，则需要设置服务器让.html后缀的网页也支持嵌入功能；<a href="http://help.wslm.cn/2007/0529/help_614.html" target="_blank" style="color:blue">点这里了解shtml技术 >></a><br />
...
<!--#include virtual="<?=WSLM_PATH?>data/<?=$M['htmldir']?>/<?=$placeid?>.html"-->
{else}
{include WSLM_ROOT.'/data/<?=$M['htmldir']?>/<?=$placeid?>.html'}
{/if}</textarea>
