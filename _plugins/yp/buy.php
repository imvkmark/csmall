...
switch($action)
{
	...
	$head['title'] .= $rs['title'].'_商机'.'_'.$WSLM['sitename'];
	$head['description'] .= $rs['title'].'_商机'.'_'.$WSLM['sitename'];
	...
	case 'search':
	$head['keywords'] .= '商机搜索';
	$head['description'] .= '商机搜索'.'_'.$WSLM['sitename'];
	$head['title'] .= '商机搜索'.'_'.$WSLM['sitename'];
	$CAT = subcat('yp', 0);
	...
	$head['description'] .= '商机搜索'.'_'.$WSLM['sitename'];
	$head['title'] .= '商机搜索结果'.'_'.$WSLM['sitename'];
	$page = $page?$page:1;
	$catid = intval($catid);
	...
	default:	
	$head['keywords'] .= '商机';
	$head['description'] .= '商机'.'_'.$WSLM['sitename'];
	$head['title'] .= '商机'.'_'.$WSLM['sitename'];
	if($catid)
	{
