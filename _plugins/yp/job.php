...
switch($action)
{
	...
	$catid = intval($catid);
	$head['keywords'] .= '职位列表';
	$head['title'] .= '职位列表'.'_'.$WSLM['sitename'];
	$head['description'] .= '职位列表'.'_'.$WSLM['sitename'];
	$templateid = 'job_list';
	if($inputtime)
	...
	$head['description'] .= '人才招聘搜索结果'.'_'.$WSLM['sitename'];
	$head['title'] .= '人才招聘搜索结果'.'_'.$WSLM['sitename'];
	if($page<1)$page = 1;
	if($stype)
	{
	...
	$head['description'] .= '人才招聘搜索'.'_'.$WSLM['sitename'];
	$head['title'] .= '人才招聘搜索'.'_'.$WSLM['sitename'];
	$templateid = 'job_search';
	break;
	
	case 'applylist';
	$head['keywords'] .= '简历列表';
	$head['description'] .= '简历列表'.'_'.$WSLM['sitename'];
	$head['title'] .= '简历列表'.'_'.$WSLM['sitename'];
	...
	$head['description'] .= $rs['title'].'_人才招聘'.'_'.$WSLM['sitename'];
	$head['title'] .= $rs['title'].'_人才招聘'.'_'.$WSLM['sitename'];
	...
	default:
	$head['keywords'] .= '人才招聘';
	$head['description'] .= '人才招聘'.'_'.$WSLM['sitename'];
	$head['title'] .= '人才招聘'.'_'.$WSLM['sitename'];
	$templateid = 'job';	
	break;
}
