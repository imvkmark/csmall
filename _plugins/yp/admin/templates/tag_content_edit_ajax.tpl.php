...
?>
    ...
    <tr> 
      ...
      <td><?=form::select_template($module, 'tag_config[template]', 'template', $template, 'style="width:250px"', 'tag_content')?>&nbsp;<input type="button" value="修改模板" title="修改模板" onClick="$('#template_edit').show();$('#template_data').load('?mod=wslm&file=template&action=data_ajax&module=<?=$module?>&template='+$('#template').val())"></td>
    </tr>
