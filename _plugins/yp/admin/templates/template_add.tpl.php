...
<input type="hidden" name="forward" value="?mod=wslm&file=area&action=manage" />
<table cellpadding="0" cellspacing="1" class="table_form">
...
<tr>
  ...
  <td>
	<input name='thumb' type='text' id='thumb' size='70' value=''>  <input type='button' value='上传缩略图' onclick="javascript:openwinx('?mod=wslm&file=upload&uploadtext=thumb&type=thumb&width=600&height=300','upload_thumb','350','350')">
  </td>
  </tr>	
  <tr>
