...
<td><input type="text" name="thumb" id="thumb" size="50" value="<?=$info['thumb']?>" require="true" datatype="limit" min="5" msg='请上传证书'>  <input type="button" name="upload" id="upload" value="上传图片" style="width:60px" onclick="javascript:openwinx('<?=WSLM_PATH?>yp/upload.php?uploadtext=thumb','upload','450','350')"/></td>
</tr>
<tr>
