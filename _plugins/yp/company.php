...
switch($action)
{
	case 'search':
	$head['keywords'] .= '企业搜索';
	$head['title'] .= '企业搜索'.'_'.$WSLM['sitename'];
	$head['description'] .= '企业搜索'.'_'.$WSLM['sitename']; 
	$CAT = subcat('yp', 0);
	...
	$head['title'] .= '企业搜索结果'.'_'.$WSLM['sitename'];
	$head['description'] .= '企业搜索结果'.'_'.$WSLM['sitename'];
	$page = $page ? $page:1;
	$catid = intval($catid);
	...
	$templateid = 'company';
	$head['keywords'] .= '企业';
	$head['description'] .= '企业'.'_'.$WSLM['sitename'];
	$head['title'] .= '企业'.'_'.$WSLM['sitename'];
	$c= new company();
	$r = $c->get_yp_arrchildid($catid);
	if($r['arrchildid'])
	{
