...
<tbody>
	...
	<tr> 
      ...
      <td><?=form::select_template('ask', 'tag_config[template]', 'template', $template, '','tag_ask')?>&nbsp;<input type="button" value="修改模板" title="修改模板" onClick="$('#template_edit').show();$('#template_data').load('?mod=wslm&file=template&action=data_ajax&module=<?=$module?>&template='+$('#template').val())"></td>
    </tr>
