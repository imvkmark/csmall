...
<table cellpadding="0" cellspacing="1" class="table_form">
   <caption><?=$M['name']?>模块配置</caption>
	...
	<tr>
	  ...
	  <a href="?mod=wslm&file=urlrule&action=add&module=ask&filename=category&forward=<?=urlencode(URL)?>" style="color:red">点击新建URL规则</a></th>
      <td>
	...
	<tr>
	  ...
	  <a href="?mod=wslm&file=urlrule&action=add&module=ask&filename=show&forward=<?=urlencode(URL)?>" style="color:red">点击新建URL规则</a></th>
      <td>
