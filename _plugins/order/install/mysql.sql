INSERT INTO `wslm_module` (`module`, `name`, `path`, `url`, `iscore`, `version`, `author`, `site`, `email`, `description`, `license`, `faq`, `tagtypes`, `setting`, `listorder`, `disabled`, `publishdate`, `installdate`, `updatedate`) VALUES ('order', '订单', 'order/', '', 0, '1.0.0.0', 'Wslm Team', 'http://www.wslm.cn/', 'wslm@163.com', '', '', '', '', 'array (\n  ''maxcloseday'' => ''7'',\n  ''maxdelivers'' => ''5'',\n)', 0, 0, '2008-11-26', '2008-11-26', '2008-11-26');

DROP TABLE IF EXISTS `wslm_order`;
CREATE TABLE IF NOT EXISTS `wslm_order` (
...
CREATE TABLE IF NOT EXISTS `wslm_order_deliver` (
...
CREATE TABLE IF NOT EXISTS `wslm_order_log` (
