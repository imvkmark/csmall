...
if(!$WSLM['uc'])  exit('Ucenter client disabled !');
require WSLM_ROOT.'member/include/common.inc.php';
require WSLM_ROOT.'member/api/client/client.php';
...
if($action == 'synlogin')
{
	...
	$wslm_auth = wslm_auth($userid."\t".$password, 'ENCODE', $wslm_auth_key);
    ob_clean() ;
...
if($action == 'updateapps') 
{
	...
	include_once WSLM_ROOT.'member/api/client/lib/xml.class.php';
	$post = xml_unserialize(file_get_contents('php://input'));

	$cachefile = WSLM_ROOT.'member/api/client/data/cache/apps.php';
