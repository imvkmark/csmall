...
function set_config($config)
{
	...
	$configfile = WSLM_ROOT.'include/config.inc.php';
...
function admin_template($module = 'wslm', $template = 'index', $istag = 0)
{
...
{
	global $mod,$MODULE,$CONFIG,$WSLM;
	if(!$module) $module = $mod;
	return WSLM_ROOT.$MODULE[$module]['path'].'admin/templates/'.$file.'.tpl.php';
}
...
function admin_menu($menuname, $submenu = array())
{
	...
	return include WSLM_ROOT.'admin/templates/admin_menu.tpl.php';
}
