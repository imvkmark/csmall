...
function dir_create($path, $mode = 0777)
{
	...
	for($i=0; $i<$max; $i++)
	{
		...
		{
			$dir = str_replace(WSLM_ROOT, '', $cur_dir);
            $ftp->mkdir($dir);
			$ftp->chmod($mode, $dir);
		}
		@chmod($cur_dir, 0777);
...
function dir_delete($dir)
{
	...
	$systemdirs = array('', WSLM_ROOT.'admin/', WSLM_ROOT.'admin/include/', WSLM_ROOT.'data/', WSLM_ROOT.'member/', WSLM_ROOT.'templates/', WSLM_ROOT.'images/');
