...
class image
{
    ...
    {
		global $WSLM;
		$this->thumb_enable = $WSLM['thumb_enable'];
		$this->watermark_enable = $WSLM['watermark_enable'];
		$this->set($WSLM['watermark_minwidth'], $WSLM['watermark_minheight'], $WSLM['watermark_quality'], $WSLM['watermark_pct']);
    }
