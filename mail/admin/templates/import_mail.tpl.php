...
<table cellpadding="0" cellspacing="1" class="table_form">
  ...
  <tr>
      ...
      <td>
        <?=form::select($data, 'dataname', 'dataname', '请选择', $dataname, '')?>&nbsp;&nbsp;&nbsp;<a href="?mod=wslm&file=datasource&action=add&forward=<?=urlencode(URL)?>">添加新数据源</a>
	  </td>
  </tr>
  <tr>
